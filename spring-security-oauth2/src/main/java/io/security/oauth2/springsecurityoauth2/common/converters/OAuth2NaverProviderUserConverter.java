...
public class OAuth2NaverProviderUserConverter implements ProviderUserConvter<ProviderUserRequest, ProviderUser> {
    @Override
    public ProviderUser converter(ProviderUserRequest providerUserRequest) {
        ...
        return new NaverUser(
                OAuth2Utils.getSubAttribute(providerUserRequest.oAuth2User(), "response"),
